...
func (_m *FakeConnector) Select(ctx context.Context, payload Payload) error {
	ret := _m.Called(ctx, payload)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, Payload) error); ok {
		r0 = rf(ctx, payload)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *FakeConnector) SetName(name string) Connector {
	ret := _m.Called(name)

	var r0 Connector
	if rf, ok := ret.Get(0).(func(string) Connector); ok {
		r0 = rf(name)
	} else {
		if ret.Get(0) != nil {
